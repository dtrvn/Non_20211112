...
import { clearShifts } from "../../actions/shift";
import { setValueLoader } from "../../actions/personInShift";
import { setShiftRegisterLoader } from "../../actions/shiftRegister";

const Navbar = ({ auth: { isAuthenticated, loading, user }, logout, clearBranchs, clearShifts, setValueLoader, setShiftRegisterLoader }) => {
  const authLinks = (
    <Fragment>
      <ul className="navbar-nav mr-auto">
        ...
        <li>
          <Link to="/shiftRegisters" onClick={() => {
            clearBranchs();
            clearShifts();
...
Navbar.propsType = {
  ...
  clearShifts: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { logout, clearBranchs, clearShifts, setValueLoader, setShiftRegisterLoader })(Navbar);
