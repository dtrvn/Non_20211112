    ...
    useEffect(() => {
        if (user) {
            if (user.roles === "User") {
                ...
                if(createDate.lastDayOfLastWeekInMonth === getLastDayOfThisWeek){
        ...
        <div class="card-group-shiftRegister">
            <div class="card-shiftRegister col-md-4">
                <div class="card-body-shiftRegister">
                    <p class="viewHeader textAlign font-salaryAll" style={{ color: "black" }} data-label="Tên nhân viên">{item}</p>
                </div>
            </div>
            <div class="card-shiftRegister col-md-3">
                <div class="card-body-shiftRegister">
                    <p class="text-right viewHeader textAlign font-salaryAll" style={{ color: "black" }} data-label="Lương">{elmSalarys[idx].toLocaleString()}</p>
                </div>
            </div>
            <div class="card-shiftRegister col-md-5">
                <div class="card-body-shiftRegister">
                    <p class="text-center font-medium m-b-0 textAlign font-salaryAll" style={{ color: "black" }}>
...
export default connect(mapStateToProps, {
    getShiftRegistersForMonth, getAllUsers, getShiftRegisterViewSalary, getShiftForSalary
})(SalaryAllMember);
