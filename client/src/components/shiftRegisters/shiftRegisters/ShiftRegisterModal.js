                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <p className="modal-header-shiftRegister">Đăng kí ca cho ngày </p>
                            <p className="modal-header-shiftRegister">{" "}(<Moment format="DD/MM">{currentDay}</Moment>)</p>
