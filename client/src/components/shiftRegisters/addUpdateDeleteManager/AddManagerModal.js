                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <p className="modal-header-shiftRegister">Cập nhật ca quản lý ngày (<Moment format="DD/MM">{currentDay}</Moment>)</p>
                            <button type="button" className="close" data-dismiss="modal" aria-hidden="true" onClick={() => clearData()}>×</button>
                        </div>
                        <form className="form" onSubmit={(e) => onSubmit(e)}>
                            {/* <AlertShiftRegister /> */}

                            <div className="modal-body-addManager">
                                ...
                                <div class="form-group">
                                    <div className="row">
                                        ...
                                        <div className="col-md-9">
                                            <div className="input-group-addManager">
                                                ...
                                                <select
                                                    ...
                                                    class="form-control-addManager custom-select-addManager"
                                                >
                                                    {elmUsers}
                                                </select>
                                            </div>
