                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <p className="modal-header-shiftRegister">Thay đổi nhân viên hoặc xoá tất cả ca đăng kí của nhân viên </p>
                            <button type="button" className="close" data-dismiss="modal" aria-hidden="true" onClick={() => clearData()}>×</button>
                        </div>
                        <form className="form" onSubmit={(e) => onSubmit(e)}>
                            <AlertShiftRegister />

                            <div className="modal-body-updateDeleteUser">

                                <div class="form-group">
                                    <div className="row">
                                        <div className="col-md-modal-3">
                                            <Switch
                                                isOn={value}
                                                onColor="#EF476F"
                                        ...
                                        <div className="col-md-modal-9">
                                            <div className="input-group-updateDeleteUser">
                                                ...
                                                <select
                                                    ...
                                                    class="form-control-updateDeleteUser custom-select-updateDeleteUser"
                                                >
                                                    {elmUsers}
                                                </select>
                                            </div>
