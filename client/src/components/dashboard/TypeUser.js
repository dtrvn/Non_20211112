  ...
  return (
    <Fragment>
      ...
      <div class="table-responsive">
        <table class="table-dashboard color-table warning-table">
          <thead>
            <tr>
              <th className="setWidthTypeUser1">Loại nhân viên</th>
              <th className="setWidthTypeUser2">Phần trăm lương</th>
              <th>Hành động</th>
            </tr>
          </thead>
