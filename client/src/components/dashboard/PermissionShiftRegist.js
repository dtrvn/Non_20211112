  ...
  return (
    <Fragment>
      ...
      <div class="table-responsive">
        <table class="table-dashboard color-table info-table">
          <thead>
            <tr>
              <th className="setWidthBranchs">Tên chi nhánh</th>
              <th className="setWidthPermissionShiftRegist">Số ca được đăng kí</th>
              <th>Hành động</th>
            </tr>
          </thead>
